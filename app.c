...
void APP_Tasks ( void )
{
    ...
    switch ( appData.state )
    {
        ...
        case APP_STATE_INIT:
        {
            ...
            //Initialisation du pont en H et démarrage des timers et des OC
            GPWM_Initialize();
            
            //Initialisation de la fonction InitFifoComm
            InitFifoComm();
            
            //Mise en état d'attente
        ...
        if(sendCounter >=5)
            ...
            sendCounter = 0;        //Remet le compteur à 0
        }
